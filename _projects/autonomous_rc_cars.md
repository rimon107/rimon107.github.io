...
img: assets/img/rc_car_preview.png
importance: 4
category: outreach
---
...
The camp used Donkey Car and Raspberry Pi-based robotic platforms to teach students the full autonomous-driving pipeline, from data collection to model training and on-vehicle deployment.
...
Autonomous driving education, Donkey Car, Raspberry Pi, Python, TensorFlow, OpenCV, robotics, cybersecurity.
